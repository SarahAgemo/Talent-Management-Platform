    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-2 space-y-6">
          {placement && <PlacementForm placement={placement} />}
...
export default async function StudentProfilePage({ params }: { params: { id: string } }) {
  ...
  // Every program this student has ever been enrolled in — the
  // student_overview view now only shows the most recent one as the
  // headline (that fix is what stopped duplicate rows/404s elsewhere
  // in the app), so anyone who did more than one program needs their
  // earlier ones surfaced here instead.
